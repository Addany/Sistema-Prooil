...
document.getElementById("loanForm").addEventListener("submit", function (event) {
    ...
    alert("Folio generado con éxito: " + folioNumber);
});
...
function onToolScanned(toolInfo) {
    ...
    // Si deseas agregar funcionalidad para desplegar más información, 
    // aquí es donde podrías hacerlo. Por ejemplo, podrías hacer que al hacer clic 
    // en una fila, se muestre más información sobre la herramienta escaneada.
}
